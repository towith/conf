...
global tNotion="ahk_exe Notion.exe"
global notionPath="D:\Applications\Scoop\apps\notion\2.0.16\Notion.exe"
...
preventNextLock(){
	...
	giveSplash("","Prevent next auto lock",5,,,190,50)
}

preventNextStart(){
	FileAppend, , %logDir%\__prevent_start__
	giveSplash("","Prevent next auto start",5,,,190,50)
}
...
doBrowser(){
	browser_options:="--remote-debugging-port=11032 --start-fullscreen --kiosk"
