...
setRow(Row_To_Focus:=0){
	...
	; SendMessage, 0x1000+19, Row_To_Focus-1, 0,, ahk_id %ListView_Control_ID% 
}
#IfWinActive
...
F9::
   code:=tdxGetCode()
   RunWaitSilent("node D:\Applications\z_disk\conf\persist\ahk\browserTabCall.js 11032 巨潮资讯网 http://www.cninfo.com.cn/new/commonUrl?url=disclosure/list/notice bovSearchStock " . code,,true)
   WinActivate, %tBrowser%,,3
return

F10::
    SendMessage,0x111,2241,0,,A
return

\ & BackSpace::
	SendMessage, 0x111, 33781,0,,A
return
\ & 3::
	SendMessage, 0x111, 33784,0,,A
return
\ & 4::
	SendMessage, 0x111, 33785,0,,A
return
\ & 5::
	SendMessage, 0x111, 33786,0,,A
return
\ & 6::
	SendMessage, 0x111, 33787,0,,A
return
\ & 7::
	SendMessage, 0x111, 33789,0,,A
return
\ & 8::
	SendMessage, 0x111, 33790,0,,A
return
\ & 9::
	SendMessage, 0x111, 33791,0,,A
return
\ & a::
	SendMessage, 0x111, 33792,0,,A
return

\ & b::
	SendMessage, 0x111, 33793,0,,A
return

\ & f::
	SendMessage,0x111,33696,0,,A  ;;set up price
return

\ & d::
	SendMessage,0x111,33697,0,,A ;; set down price
return 

\ & x::
	SendMessage,0x111,4195,0,,A ;; delete
return

=::
	SendMessage, 0x111, 31977,0,,A ;; no sort
return
!::
	SendMessage, 0x111, 1929,0,,A
return

^!h::
	SendMessage, 0x111, 2605,0,,A
return
...
^!m::
    SendMessage, 0x111, 2627,0,,A
return

^+!m::
	Run, autohotkey D:\Applications\z_disk\conf\persist\ahk\lib\contextMenuMessage.ahk
return
